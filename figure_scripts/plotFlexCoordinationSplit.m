function plotFlexCoordinationSplit(learner_summary,nonLearner_summary,dataPt,group)

% plots paw orientation as a function of z-digit2 (learners - group 1;
% non-learners - group 2)

if group == 1   % convert data to degrees, set line colors, set min number of rats needed per point to include in plot
    data = (learner_summary.mean_flexion_traj*180)/pi;
    ...
    data = (nonLearner_summary.mean_flexion_traj*180)/pi;
