function plotApertureAtDistIndivSplit(learner_summary,nonLearner_summary,dataPt,group)

% plots individual rats' aperture at selected z-digit2 value for 10
% sessions (learners - group 1; non-learners - group 2)
...
if group == 1
    ...
    data = nonLearner_summary.mean_aperture_traj;
...
selData = data(:,:,dataPt); % pull out data at specific z-digit2 value
...
set(gca,'ylim',[7 15],'ytick',[7 11 15]);
set(gca,'xlim',[.5 10.5]);
