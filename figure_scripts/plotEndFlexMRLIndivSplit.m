function plotEndFlexMRLIndivSplit(learner_summary,nonLearner_summary,group)

% plots individual rats' average digit flexion variance at reach end over
% sessions (learners - group 1; non-learners - group 2)

if group == 1   % pull out data, set plot color
	data = learner_summary.end_MRL_flex';
    plot_color = {[0/255 102/255 0/255] [95/255 130/255 226/255] [216/255 85/255 116/255] [212/255 216/255 85/255]};
else
    data = nonLearner_summary.end_MRL_flex';
