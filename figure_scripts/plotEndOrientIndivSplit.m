function plotEndOrientIndivSplit(learner_summary,nonLearner_summary,group)

% plots individual rats' average paw orientation at reach end over sessions
% (learners - group 1; non-learners - group 2)

if group == 1   % pull out data & convert to degrees, set plot color
	data = ((learner_summary.mean_end_orientations*180)/pi)';
    plot_color = {[0/255 102/255 0/255] [95/255 130/255 226/255] [216/255 85/255 116/255] [212/255 216/255 85/255]};
else
    data = ((nonLearner_summary.mean_end_orientations*180)/pi)';
...
% figure properties
box off
set(gca,'ylim',[15 75],'ytick',[15 45 75]);
ylabel({'\theta at reach'; 'end (mm)'})
xlabel('day number')
set(gca,'xlim',[.5 10.5]);
