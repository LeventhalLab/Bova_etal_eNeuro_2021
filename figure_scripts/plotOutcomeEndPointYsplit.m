function plotOutcomeEndPointYsplit(exptOutcomeSummary,group)

% plots reach endpoint of digit2 (Y) for successful vs. failed reaches
...
maxValue = 12;
box off
set(gca,'xlim',[.5 10.5],'ylim',[minValue maxValue],'ytick',[0 6 12]);
