function plotAvgEndOrientVarSplit(learner_summary,nonLearner_summary,learning_summary)

% plots average paw orientation MRL (variability) at reach end (learners,
% non-learners, and all rats combined)

varDataL = learner_summary.end_MRL; % pull out data
varDataN = nonLearner_summary.end_MRL;
varDataA = learning_summary.end_MRL;
