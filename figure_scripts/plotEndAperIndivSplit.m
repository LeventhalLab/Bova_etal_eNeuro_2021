function plotEndAperIndivSplit(learner_summary,nonLearner_summary,group)

% plots individual rats' average digit aperture at reach end over sessions
% (learners (1) and non-learners (2) plotted separately)

if group == 1   % get data, set color
	data = learner_summary.mean_end_aperture';
    plot_color = {[0/255 102/255 0/255] [95/255 130/255 226/255] [216/255 85/255 116/255] [212/255 216/255 85/255]};
else
    data = nonLearner_summary.mean_end_aperture';
...
% figure properties
box off
set(gca,'ylim',[8 22],'ytick',[8 15 22]);
