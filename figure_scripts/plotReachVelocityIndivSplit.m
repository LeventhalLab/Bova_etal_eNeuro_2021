function plotReachVelocityIndivSplit(learner_summary,nonLearner_summary,grp)

% plots individual rats' average reach velocity over sessions

if grp == 1 % get data, set plot colors based on group (grp)
    data = learner_summary.mean_pd_v;
    plot_color = {[0/255 102/255 0/255] [95/255 130/255 226/255] [216/255 85/255 116/255] [212/255 216/255 85/255]};
else
    data = nonLearner_summary.mean_pd_v;
...
% figure properties
box off
set(gca,'ylim',[300 1400]);
set(gca,'ytick',[300 850 1400]);
