function plotAvgDigEndptCoorIndivSplit(learner_summary,nonLearner_summary,i_coor,group)

% plot individual rats' average endpoint of paw dorsum in x, y, or z direction 
% (set by i_coor)

if group == 1   % pull out endpoint data from selected coordinate direction, set plot colors
	data = learner_summary.mean_dig2_endPt_reach(:,:,i_coor); 
    plot_color = {[0/255 102/255 0/255] [95/255 130/255 226/255] [216/255 85/255 116/255] [212/255 216/255 85/255]};
else
    data = nonLearner_summary.mean_dig2_endPt_reach(:,:,i_coor);
