function plotFlexAtDistSplit(learner_summary,nonLearner_summary,dataPt)

% plots orientation at selected z-digit2 value for 10 sessions (learners,
% non-learners, and all rats combined)

numSessions = size(learner_summary.mean_aperture_traj,2);
data = (learner_summary.mean_flexion_traj*180)/pi;  % convert data to degrees
dataN = (nonLearner_summary.mean_flexion_traj*180)/pi;
...
xlabel('day number')
set(gca,'ylim',[10 50],'ytick',[10 30 50]);
set(gca,'xlim',[.5 10.5]);
