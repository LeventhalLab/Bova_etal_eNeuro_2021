function plotAverageVariablityReachPawIndivSplit(learner_summary,nonLearner_summary,grp)

% plots individual rats' average reach trajectory variability (mean dist.
% from avg. trajectory) 

if grp == 1 % load data, set colors based on group
    distData = learner_summary.mean_pd_dist_from_traj_reach;
    plot_color = {[0/255 102/255 0/255] [95/255 130/255 226/255] [216/255 85/255 116/255] [212/255 216/255 85/255]};
else
    distData = nonLearner_summary.mean_pd_dist_from_traj_reach;
