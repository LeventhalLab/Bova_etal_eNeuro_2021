function plotOutcomeEndPointZindiv(exptOutcomeSummary,group,i_out)
...
if group == 1   % set colors, pull out data
    ...
    data = exptOutcomeSummary.mean_dig2_endPt_z(:,:,learningRats);
else
    ...
    data = exptOutcomeSummary.mean_dig2_endPt_z(:,:,nonLearningRats);
end
...
% figure properties
box off
set(gca,'xlim',[.5 10.5],'ylim',[-20 15],'ytick',[-20 0 15]);
set(gca,'xtick',[2:2:10]);
set(gca,'FontSize',10);
ylabel({'reach endpoint'; 'z (mm)'})
